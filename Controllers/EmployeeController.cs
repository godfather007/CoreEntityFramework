...
namespace CoreEntityFramework.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Gender,Department,City")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Gender,Department,City")] Employee employee)
        {
            if (id != employee.ID)
            {
                return NotFound();
